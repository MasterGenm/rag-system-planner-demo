#!/usr/bin/env python3
"""Render a Markdown RAG solution package from structured JSON input.

Expected input shape:
{
  "title": "RAG Solution Package",
  "problem_summary": "...",
  "recommended_stack": ["..."],
  "rollout": {
    "Phase 1": ["..."],
...
SECTIONS = [
    ...
    ("retrieval_design", "Retrieval Design"),
    ("agent_guidance", "Agent Integration Guidance"),
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Render a Markdown RAG solution package from structured JSON input.",
        epilog='Example: echo {"title":"Plan","problem_summary":"..."} | python render_rag_plan.py',
    )
    ...
    title = format_heading_text(payload.get("title", "RAG Solution Package"))
